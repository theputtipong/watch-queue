...
export function ItemCard({ item, userId, initialQueueState }: ItemCardProps) {
  // ใช้ Custom Hook เพื่อจัดการ State Machine ภายใน Card (รับประกันว่า Component จะ Render และ Dispatch event)
