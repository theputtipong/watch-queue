...
export const mockCatalog: VideoItem[] = [
  ...
  { id: 'v3', title: 'Interstellar', genre: 'Sci-Fi', thumbnailUrl: 'https://placehold.co/300x170/222222/FFFFFF/png?text=Interstellar', duration: '2h 49m', year: 2014, rating: 'PG-13' },
  { id: 'v4', title: 'The Dark Knight', genre: 'Action', thumbnailUrl: 'https://placehold.co/300x170/222222/FFFFFF/png?text=The+Dark+Knight', duration: '2h 32m', year: 2008, rating: 'PG-13' },
  { id: 'v5', title: 'Pulp Fiction', genre: 'Crime', thumbnailUrl: 'https://placehold.co/300x170/222222/FFFFFF/png?text=Pulp+Fiction', duration: '2h 34m', year: 1994, rating: 'R' },
  { id: 'v6', title: 'Avengers: Endgame', genre: 'Action', thumbnailUrl: 'https://placehold.co/300x170/222222/FFFFFF/png?text=Avengers', duration: '3h 1m', year: 2019, rating: 'PG-13' },
